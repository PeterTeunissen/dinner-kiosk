...
public class PlanAssignment {
	...
	public DinnerIdea getIdea() {
		return idea;
	}

	public void setIdea(DinnerIdea idea) {
		this.idea = idea;
	}

	public String getMealTitleSnapshot() {
		return mealTitleSnapshot;
	}

	public void setMealTitleSnapshot(String mealTitleSnapshot) {
		this.mealTitleSnapshot = mealTitleSnapshot;
	}
}
